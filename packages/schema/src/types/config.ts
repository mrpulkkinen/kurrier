...
let _cache:
    | { server: ServerConfig; public: PublicConfig }
    | null = null;

export function parseEnv(env: RawEnv): { server: ServerConfig; public: PublicConfig } {
    return {
...
export function getServerEnv(env: RawEnv = process.env as unknown as RawEnv): ServerConfig {
    return parseServerConfig(env);
}

export function getPublicEnv(env: RawEnv = process.env as unknown as RawEnv): PublicConfig {
