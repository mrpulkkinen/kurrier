import {addNewDomainIdentity, FetchDecryptedSecretsResult} from "@/lib/actions/dashboard";
    ...
    const fields = [
        {
            ...
            props: {
                ...
                onChange: (val: unknown) => {
                    ...
                    const found = providerAccounts.find(s => String(s.linkRow.id) === id) ?? null;
                    setProvider(found);
                },
            },
        },
        ...
        { name: "kind", wrapperClasses: "hidden", props: { hidden: true, defaultValue: "domain" } },
            ...
            ? ([
                {
                    ...
                    bottomStartPrefix: (
                        <p className="text-xs text-muted-foreground">
                            Improves SPF and DMARC alignment by ensuring your messages appear to come
                            directly from your domain, which helps reduce the chance of emails being
                            flagged as spam.
                        </p>
                    )
                },
