...
function AddEmailIdentityForm({
    ...
    const [provider, setProvider] =
        React.useState<FetchDecryptedSecretsResult[number] | null>(null);
    const [smtpAccount, setSmtpAccount] =
        React.useState<FetchDecryptedSecretsResult[number] | null>(null);
...
// import {addNewEmailIdentity, FetchDecryptedSecretsResult, FetchUserIdentitiesResult} from "@/lib/actions/dashboard";
// import { ReusableForm } from "@/components/common/reusable-form";
// import React from "react";
// import {parseSecret} from "@/lib/utils";
//
...
//     userDomainIdentities: FetchUserIdentitiesResult
// }) {
//     const [provider, setProvider] = React.useState<FetchDecryptedSecretsResult[number] | null>(null);
//     const [smtpAccount, setSmtpAccount] = React.useState<FetchDecryptedSecretsResult[number] | null>(null);
//     const [activeId, setActiveId] = React.useState<string | null>(null);
//
//     console.log("userDomainIdentities", userDomainIdentities)
//
//     function getSmtpFields() {
//         const parsedVaultValues = parseSecret(smtpAccount)
//         return [
...
//                 },
//             },
//             { name: "smtpAccountId", wrapperClasses: "hidden", props: { hidden: true, defaultValue: smtpAccount?.linkRow.accountId } },
//             { name: "kind", wrapperClasses: "hidden", props: { hidden: true, defaultValue: "email" } },
//         ];
//     }
//
//     function getSesFields() {
//         // const parsedVaultValues = parseSecret(provider)
//         return [
//             {
//                 name: "value",
//                 label: "Email address",
...
//                 kind: "select" as const,
//                 options: userDomainIdentities?.map((userDomainIdentity) => {
//                   return {label: userDomainIdentity.identities.value, value: userDomainIdentity.identities.id}
//                 }),
//                 required: false,
//                 wrapperClasses: "col-span-6",
//                 props: {
...
//                 },
//             },
//             { name: "providerId", wrapperClasses: "hidden", props: { hidden: true, defaultValue: provider?.linkRow.providerId } },
//             { name: "kind", wrapperClasses: "hidden", props: { hidden: true, defaultValue: "email" } },
//         ];
//     }
//
...
//                     const id = v?.replace(/^[a-z]+-/, "") || null
//                     const foundProvider = providerAccounts.find(s => String(s.linkRow.id) === id) ?? null;
//                     const foundSmtpAccount = smtpAccounts.find(s => String(s.linkRow.id) === id) ?? null;
//                     if (foundProvider) {
//                         setProvider(foundProvider)
//                         setActiveId(String(foundProvider.linkRow.providerId))
//                     }
