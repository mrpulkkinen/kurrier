                ...
                <CommandInput
                    ...
                    onKeyDown={(e) => {
                        if (e.key === "Enter") {
                            ...
                            setOpen(false);
                            router.push(
                                `/mail/${publicId}/${mailboxSlug}/search?q=${encodeURIComponent(query)}&has=${hasAttachment ? "1" : "0"}&unread=${onlyUnread ? "1" : "0"}&starred=${isStarred ? "1" : "0"}`,
                            );
                        }
                    }}
                />
                        ...
                        <ul className="space-y-2">
                            {items.map((t) => (
                                <li key={t.id} className={"my-2"}>
                                    <Link
                                        href={`/mail/${publicId}/inbox/threads/${t.threadId}`}
                                        type="button"
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className={"flex mt-0.5"}>
                                                {t.starred ? <IconStarFilled className={"text-yellow-400"} size={12} /> : <IconStar className="h-3 w-3" />}
                                            </span>
                                            <span
                                                aria-hidden
