...
import { Archive, Mail, MailOpen, MoreHorizontal, Paperclip, Trash2 } from "lucide-react";
...
export default function ThreadListItem({ threadItem, activeMailbox, identityPublicId }: Props) {
