...
import { ActionIcon, Select, SelectProps, TagsInput, Group, Text } from "@mantine/core";
...
function EditorHeader() {
    ...
    const renderOption: SelectProps["renderOption"] = ({ option }) => {
        const ItemIcon = options.find((o) => o.value === option.value)?.Icon ?? Reply;
        return (
            <Group gap="xs">
                <ItemIcon size={16} />
    ...
    const CurrentIcon = (options.find((o) => o.value === mode)?.Icon ?? Reply) as typeof Reply;
            ...
            <div className="border-b p-2 flex gap-2">
                ...
                <div className="flex-grow flex justify-between">
                    ...
                    <div className="flex gap-2 items-center text-sm text-neutral-500">
                        {!ccActive && (
                            <ActionIcon onClick={() => setCcActive(true)} variant="transparent">
                                Cc
                            </ActionIcon>
                        )}
                        {!bccActive && (
                            <ActionIcon onClick={() => setBccActive(true)} variant="transparent">
                                Bcc
                            </ActionIcon>
                        )}
                    </div>
