...
import {TextEditor, TextEditorHandle} from "@/components/mailbox/default/editor/rich-text-editor";
...
const EmailEditor = forwardRef<EmailEditorHandle, Props>(({ onReady, message }, ref) => {
