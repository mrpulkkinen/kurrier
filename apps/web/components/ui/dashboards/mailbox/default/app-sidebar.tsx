...
import {ArchiveX, Command, File, Inbox, MailPlus, Send, Trash2} from "lucide-react"
...
export function AppSidebar({  activeMailbox, mailboxList, identity, ...rest }: React.ComponentProps<typeof Sidebar> & { activeMailbox: MailboxEntity, mailboxList: MailboxEntity[], identity: IdentityEntity }) {
