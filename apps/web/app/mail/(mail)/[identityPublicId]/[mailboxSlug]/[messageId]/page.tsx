...
async function Page({params}: {params: {identityPublicId: string, mailboxSlug: string, messageId: string}}) {
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
            ...
            <div className={"flex gap-4"}>
                <div className={"flex-shrink flex flex-col items-center pt-12"}>
                    <Avatar name={message.fromName || message.fromEmail || ""} color="initials" />
                </div>
