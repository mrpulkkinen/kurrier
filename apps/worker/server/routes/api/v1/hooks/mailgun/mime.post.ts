...
export default defineEventHandler(async (event) => {
    try {
        ...
        const mailgunFlag: string = String(headers.get("x-mailgun-sflag") ?? "").toLowerCase();
        ...
        const authSaysJunk: boolean = mailgunSaysSpam || (spfFail && dkimFail && dmarcFail) || dmarcFail;
